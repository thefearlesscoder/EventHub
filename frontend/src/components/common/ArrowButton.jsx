...
import TextParallax from './TextParallel';
import aboutBg from '../../assets/aboutbg01.jpg'; // adjust path if needed

export const About = () => {
  return (
    <div
      id="about"
      className="flex flex-col w-full h-auto relative px-12 py-24 md:p-24 gap-6 text-black bg-white overflow-hidden"
    >
      ...
      <div
        className="relative flex h-[50vh] md:h-screen w-full bg-cover bg-center"
